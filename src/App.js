...
function App() {
    ...
    useEffect(() => {
        const fectdata = async () => {
            ...
            const {web3, getAccount, getBlockNumber, getChainId, getBalance, getNodeInfo, getPairPriceList, gasTransfer, findLiquidity, removeLiquidity, removeEthLiquidity, erc20Approve, erc20Allowance, erc20Transfer, addETHLiquidity, addErc20Liquidity, getDeadline, dodoApi,swapTokensForTokens,swapTokenForETH,swapETHForToken} = connectWeb3
            ...
            //     }
            // }
            // const isSwaped = await swapETHForToken('0xa71edc38d189767582c38a3145b5873052c3e47a',0.001,0.5,REACT_APP_PAIR_ABI,REACT_APP_ROUTER_ABI,'0xed7d5f38c79115ca12fe6c0041abb22f0a06c300')
